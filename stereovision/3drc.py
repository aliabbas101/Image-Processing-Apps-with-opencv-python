...
def build_arg_parser():
    ...
    parser.add_argument("--image-left",dest="image_left",required=True, help="Image captured from the left view")
    parser.add_argument("--image-right",dest="image_right",required=True, help="Image captured from the right view")
